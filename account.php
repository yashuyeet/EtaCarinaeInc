            ...
            <div class="container">
              <div class="row justify-content-start">
                <div class="col-lg-8">
                  ...
                  <h1 class="display-1 mb-4 animated slideInDown">Welcome, <?php echo $auth->getUsername(); ?></h1>
                  <a href="logout.php" class="btn btn-primary py-3 px-5 animated slideInDown">Logout</a>
                </div>
              </div>
            </div>
          </div>
